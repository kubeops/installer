...
*/}}
{{- define "operator-shard-manager.name" -}}
...
*/}}
{{- define "operator-shard-manager.fullname" -}}
...
*/}}
{{- define "operator-shard-manager.chart" -}}
...
Common labels
*/}}
{{- define "operator-shard-manager.labels" -}}
helm.sh/chart: {{ include "operator-shard-manager.chart" . }}
{{ include "operator-shard-manager.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "operator-shard-manager.selectorLabels" -}}
app.kubernetes.io/name: {{ include "operator-shard-manager.name" . }}
...
*/}}
{{- define "operator-shard-manager.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "operator-shard-manager.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- $ca := genCA "ca" 3650 }}
{{- $cn := include "operator-shard-manager.fullname" . -}}
