...
$ helm repo update
$ helm search repo appscode/operator-shard-manager --version=v2026.1.15
$ helm upgrade -i operator-shard-manager appscode/operator-shard-manager -n ace --create-namespace --version=v2026.1.15
```
...
```bash
$ helm upgrade -i operator-shard-manager appscode/operator-shard-manager -n ace --create-namespace --version=v2026.1.15 --set replicaCount=1
```
...
```bash
$ helm upgrade -i operator-shard-manager appscode/operator-shard-manager -n ace --create-namespace --version=v2026.1.15 --values values.yaml
```
