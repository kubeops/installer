...
*/}}
{{- define "petset.webhook-ca-bundle" -}}
...
*/}}
{{- define "petset.webhook-ca-inject-annotations" -}}
{{- if .Values.apiserver.servingCerts.certManager.enabled }}
cert-manager.io/inject-ca-from-secret: {{ printf "%s/%s-cert" .Release.Namespace (include "petset.fullname" .) }}
{{- end }}
{{- end }}