...
$ helm repo update
$ helm search repo appscode/fargocd-manager --version=v2026.2.16
$ helm upgrade -i fargocd-manager appscode/fargocd-manager -n open-cluster-management-fargocd --create-namespace --version=v2026.2.16
```
...
```bash
$ helm upgrade -i fargocd-manager appscode/fargocd-manager -n open-cluster-management-fargocd --create-namespace --version=v2026.2.16 --set registryFQDN=ghcr.io
```
...
```bash
$ helm upgrade -i fargocd-manager appscode/fargocd-manager -n open-cluster-management-fargocd --create-namespace --version=v2026.2.16 --values values.yaml
```
