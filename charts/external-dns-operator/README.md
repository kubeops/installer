...
$ helm repo update
$ helm search repo appscode/external-dns-operator --version=v2026.6.22
$ helm upgrade -i external-dns-operator appscode/external-dns-operator -n kubeops --create-namespace --version=v2026.6.22
```
...
```bash
$ helm upgrade -i external-dns-operator appscode/external-dns-operator -n kubeops --create-namespace --version=v2026.6.22 --set replicaCount=1
```
...
```bash
$ helm upgrade -i external-dns-operator appscode/external-dns-operator -n kubeops --create-namespace --version=v2026.6.22 --values values.yaml
```
