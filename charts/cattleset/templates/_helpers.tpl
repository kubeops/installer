...
Common labels
*/}}
{{- define "cattleset.labels" -}}
helm.sh/chart: {{ include "cattleset.chart" . }}
{{ include "cattleset.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "cattleset.selectorLabels" -}}
app.kubernetes.io/name: {{ include "cattleset.name" . }}
...
*/}}
{{- define "cattleset.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "cattleset.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
Prepare certs
*/}}
{{- define "cattleset.prepare-certs" -}}
{{- if not ._caCrt }}
{{- $caCrt := "" }}
{{- $serverCrt := "" }}
{{- $serverKey := "" }}
...
*/}}
{{- define "cattleset.webhook-ca-bundle" -}}
...
*/}}
{{- define "cattleset.webhook-ca-inject-annotations" -}}
{{- if .Values.apiserver.servingCerts.certManager.enabled }}
cert-manager.io/inject-ca-from-secret: {{ printf "%s/%s-cert" .Release.Namespace (include "cattleset.fullname" .) }}
{{- end }}
{{- end }}