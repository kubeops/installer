...
Common labels
*/}}
{{- define "taskqueue.labels" -}}
helm.sh/chart: {{ include "taskqueue.chart" . }}
{{ include "taskqueue.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "taskqueue.selectorLabels" -}}
app.kubernetes.io/name: {{ include "taskqueue.name" . }}
...
*/}}
{{- define "taskqueue.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "taskqueue.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
Prepare certs
*/}}
{{- define "taskqueue.prepare-certs" -}}
{{- if not ._caCrt }}
{{- $caCrt := "" }}
{{- $serverCrt := "" }}
{{- $serverKey := "" }}
