...
$ helm repo update
$ helm search repo appscode/taskqueue --version=v2025.12.15
$ helm upgrade -i taskqueue appscode/taskqueue -n argocd --create-namespace --version=v2025.12.15
```
...
```bash
$ helm upgrade -i taskqueue appscode/taskqueue -n argocd --create-namespace --version=v2025.12.15 --set replicaCount=1
```
...
```bash
$ helm upgrade -i taskqueue appscode/taskqueue -n argocd --create-namespace --version=v2025.12.15 --values values.yaml
```
