...
$ helm repo update
$ helm search repo appscode/sidekick --version=v2024.8.21
$ helm upgrade -i sidekick appscode/sidekick -n kubeops --create-namespace --version=v2024.8.21
```
...
```bash
$ helm upgrade -i sidekick appscode/sidekick -n kubeops --create-namespace --version=v2024.8.21 --set replicaCount=1
```
...
```bash
$ helm upgrade -i sidekick appscode/sidekick -n kubeops --create-namespace --version=v2024.8.21 --values values.yaml
```
