...
$ helm repo update
$ helm search repo appscode/sidekick --version=v2023.10.1
$ helm upgrade -i sidekick appscode/sidekick -n kubeops --create-namespace --version=v2023.10.1
```
...
```bash
$ helm upgrade -i sidekick appscode/sidekick -n kubeops --create-namespace --version=v2023.10.1 --set replicaCount=1
```
...
```bash
$ helm upgrade -i sidekick appscode/sidekick -n kubeops --create-namespace --version=v2023.10.1 --values values.yaml
```
