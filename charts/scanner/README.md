...
$ helm repo update
$ helm search repo appscode/scanner --version=v2022.06.14
$ helm upgrade -i scanner appscode/scanner -n kubeops --create-namespace --version=v2022.06.14
```
...
| image.repository                     | Name of operator container image                                                                                                                                                                                                                                                                                                                              | <code>scanner</code>                      |
...
| licenses                             | Offline licenses for various products. Get a license by following the steps from [here](https://license-issuer.appscode.com/). <br> Example: <br> `helm install appscode/scanner \` <br> `--set-file licenses.key1=/path/to/license/file1 \` <br> `--set-file licenses.key2=/path/to/license/file2`                                                           | <code>{}</code>                           |
| nats.addr                            |                                                                                                                                                                                                                                                                                                                                                               | <code>""</code>                           |
...
```bash
$ helm upgrade -i scanner appscode/scanner -n kubeops --create-namespace --version=v2022.06.14 --set replicaCount=1
```
...
```bash
$ helm upgrade -i scanner appscode/scanner -n kubeops --create-namespace --version=v2022.06.14 --values values.yaml
```
