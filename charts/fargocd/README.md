...
$ helm repo update
$ helm search repo appscode/fargocd --version=v2025.12.15
$ helm upgrade -i fargocd appscode/fargocd -n argocd --create-namespace --version=v2025.12.15
```
...
```bash
$ helm upgrade -i fargocd appscode/fargocd -n argocd --create-namespace --version=v2025.12.15 --set replicaCount=1
```
...
```bash
$ helm upgrade -i fargocd appscode/fargocd -n argocd --create-namespace --version=v2025.12.15 --values values.yaml
```
