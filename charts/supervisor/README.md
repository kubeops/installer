...
$ helm repo update
$ helm search repo appscode/supervisor --version=v2023.03.23
$ helm upgrade -i supervisor appscode/supervisor -n kubeops --create-namespace --version=v2023.03.23
```
...
```bash
$ helm upgrade -i supervisor appscode/supervisor -n kubeops --create-namespace --version=v2023.03.23 --set replicaCount=1
```
...
```bash
$ helm upgrade -i supervisor appscode/supervisor -n kubeops --create-namespace --version=v2023.03.23 --values values.yaml
```
