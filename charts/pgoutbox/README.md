...
$ helm repo update
$ helm search repo appscode/pgoutbox --version=v2026.7.10
$ helm upgrade -i pgoutbox appscode/pgoutbox -n kubeops --create-namespace --version=v2026.7.10
```
...
| service.port                               | This sets the ports more information can be found here: https://kubernetes.io/docs/concepts/services-networking/service/#field-spec-ports                                                        | <code>8080</code>         |
| ingress.enabled                            |                                                                                                                                                                                                  | <code>false</code>        |
| ingress.className                          |                                                                                                                                                                                                  | <code>""</code>           |
| ingress.annotations                        |                                                                                                                                                                                                  | <code>{}</code>           |
| ingress.tls                                |                                                                                                                                                                                                  | <code>[]</code>           |
| resources                                  |                                                                                                                                                                                                  | <code>{}</code>           |
| startupProbe.httpGet.path                  |                                                                                                                                                                                                  | <code>/healthz</code>     |
| startupProbe.httpGet.port                  |                                                                                                                                                                                                  | <code>http</code>         |
| startupProbe.periodSeconds                 |                                                                                                                                                                                                  | <code>10</code>           |
| startupProbe.timeoutSeconds                |                                                                                                                                                                                                  | <code>1</code>            |
| startupProbe.failureThreshold              |                                                                                                                                                                                                  | <code>70</code>           |
...
```bash
$ helm upgrade -i pgoutbox appscode/pgoutbox -n kubeops --create-namespace --version=v2026.7.10 --set replicaCount=1
```
...
```bash
$ helm upgrade -i pgoutbox appscode/pgoutbox -n kubeops --create-namespace --version=v2026.7.10 --values values.yaml
```
