...
KUBEOPS_EXTERNAL_DNS_OPERATOR_TAG=${KUBEOPS_EXTERNAL_DNS_OPERATOR_TAG:-v0.2.0}
KUBEOPS_PETSET_TAG=${KUBEOPS_PETSET_TAG:-v0.0.15}
KUBEOPS_SIDEKICK_TAG=${KUBEOPS_SIDEKICK_TAG:-v0.0.12}
